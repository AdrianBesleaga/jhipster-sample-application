...
import xyz.adrianweb.demo.config.KafkaProperties;

class DemoJhipsterKafkaResourceIT {
    ...
    void setup() {
        ...
        DemoJhipsterKafkaResource kafkaResource = new DemoJhipsterKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/demo-jhipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/demo-jhipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
