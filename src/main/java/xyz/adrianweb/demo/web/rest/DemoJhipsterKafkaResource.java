...
@RestController
@RequestMapping("/api/demo-jhipster-kafka")
public class DemoJhipsterKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DemoJhipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DemoJhipsterKafkaResource(KafkaProperties kafkaProperties) {
